...
import slide from "@/app/debut/OnboadingEleves/slides";
import OnboardingItems from "@/app/debut/OnboadingEleves/onboardingItems";
import Paginator from "@/app/debut/OnboadingEleves/paginator";
        ...
        <View style={styles.container}>
            <View style={{
                ...
                <View style={styles.footer}>
                    ...
                    <Button
                        title={currentIndex === slide.length - 1 ? "Je commence" : ">>>"}
