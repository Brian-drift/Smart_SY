...
const OnboardingItemsProfesseurs  = ({ item }: { item: any } ) => { // Si TypeScript, { item: any } est une bonne pratique. Sinon, juste ({ item })
...
export default OnboardingItemsProfesseurs ;